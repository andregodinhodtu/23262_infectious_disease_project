...
### Job name
#PBS -N plasmidfinder_summary_group1
### Output files
...
summary_script="/home/projects/course_23262/tools/WGStools_summary/plasmidfinder_summary.py"

# --- summarise original data ---
echo "Summarising our_data..."
python "$summary_script" \
    -i "$RESULTS_DIR/our_data/." \
    -o "plasmidfinder_summary_our_data"

# --- summarise augmented data ---
echo "Summarising augmented data..."
python "$summary_script" \
    -i "$RESULTS_DIR/augmented/." \
    -o "plasmidfinder_summary_augmented"
