...
#PBS -N GWAS_Tanz_group1
#PBS -e /home/projects/course_23262/group/group1/23262_infectious_disease_project/results/pan_genome_GWAS/scoary_Tanz_GWAS.err
#PBS -o /home/projects/course_23262/group/group1/23262_infectious_disease_project/results/pan_genome_GWAS/scoary_Tanz_GWAS.log
#PBS -l nodes=1:ppn=4
#PBS -l mem=32gb
