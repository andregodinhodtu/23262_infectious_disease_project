...
### Output files
#PBS -e /home/projects/course_23262/group/group1/23262_infectious_disease_project/results/resfinder_aug/errs/
#PBS -o /home/projects/course_23262/group/group1/23262_infectious_disease_project/results/resfinder_aug/logs/
...
# PATHS
RESULTS_DIR="/home/projects/course_23262/group/group1/23262_infectious_disease_project/results/resfinder_aug"
ASSEMBLY_DIR="/home/projects/course_23262/group/group1/23262_infectious_disease_project/data/mlstpub_data/africa_genomes"
...
# More robust than ls — guaranteed sorted
ASSEMBLY=$(find "$ASSEMBLY_DIR" -maxdepth 1 -name "*.fasta" | sort | sed -n "${PBS_ARRAYID}p")
